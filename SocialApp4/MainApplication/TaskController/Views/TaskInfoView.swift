...
class TaskInfoView: UIView {
    ...
    required init?(coder: NSCoder) {
      ...
      override func layoutSubviews() {
          ...
          costLabel.topAnchor.constraint(equalTo: kontoStackView.topAnchor, constant: -30).isActive = true
          costLabel.centerXAnchor.constraint(equalTo: self.centerXAnchor).isActive = true
          costLabel.text = "Kosten"
          
          kontoStackView.bottomAnchor.constraint(equalTo: seperator.topAnchor, constant: -paddingTop).isActive = true
          ...
          seperator.bottomAnchor.constraint(equalTo: actionButton.topAnchor, constant: -paddingTop).isActive = true
          ...
          actionButton.bottomAnchor.constraint(equalTo: declareLabel.topAnchor, constant: -paddingTop).isActive = true
          actionButton.leftAnchor.constraint(equalTo: self.leftAnchor, constant: 12).isActive = true
          actionButton.rightAnchor.constraint(equalTo: self.rightAnchor, constant: -12).isActive = true
          ...
          declareLabel.bottomAnchor.constraint(equalTo: self.bottomAnchor, constant: -60).isActive = true
